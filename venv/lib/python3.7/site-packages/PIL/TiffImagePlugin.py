...
class ImageFileDirectory_v2(MutableMapping):
        ...
        try:
            for i in range(self._unpack("H", self._ensure_read(fp, 2))[0]):
                ...
                if size > 4:
                    ...
                    msg += " Tag Location: {} - Data Location: {}".format(
                        here, offset
                    )
                    fp.seek(offset)
    ...
    def tobytes(self, offset=0):
        ...
        for tag, typ, count, value, data in entries:
            logger.debug(
                "{} {} {} {} {}".format(
                    tag, typ, count, repr(value), repr(data)
                )
            )
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _setup(self):
        ...
        logger.debug(
            "- planar_configuration: {}".format(self._planar_configuration)
        )
