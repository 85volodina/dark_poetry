...
class EngineBase(object):
    ...
    def flip_dimensions(self, image, geometry=None, options=None):
        ...
        if (
            options.get("orientation", settings.THUMBNAIL_ORIENTATION)
            and not reoriented
        ):
    ...
    def scale(self, image, geometry, options):
        ...
        factor = self._calculate_scaling_factor(
            x_image, y_image, geometry, options
        )
    ...
    def crop(self, image, geometry, options):
        ...
        if not crop or crop == "noop":
            ...
            return self._entropy_crop(
                image, geometry[0], geometry[1], x_image, y_image
            )
